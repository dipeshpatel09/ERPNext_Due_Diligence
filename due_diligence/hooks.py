...
app_publisher = "Offshore Evolution Pvt Ltd"
app_description = "This application for send Quote Due Diligence to customer via email and again send to customer on Acceptance of quote."
